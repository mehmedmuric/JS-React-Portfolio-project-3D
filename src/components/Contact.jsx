...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send(
      ...
      {
        from_name: form.name,
        to_name: 'Mehmed Muric',
        from_email: form.email,
        to_email: 'mehmedmuric22@gmail.com',
    ...
    <div className='xl:mt-12 xl:flex-row flex-col-reverse flex overflow-hidden gap-10'> 
      <motion.div variants={slideIn("left", "tween", 0.2, 1)} className='flex-[0.75] bg-black-100 rounded-2xl p-8'>
        ...
        >
          ...
          <button 
           type='submit'
           className='px-8 py-3 bg-tertiary outline-none w-fit text-white font-bold shadow-md shadow-primary rounded-xl'
          >
